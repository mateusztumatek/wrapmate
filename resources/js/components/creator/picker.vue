<template>
    <div>
        ...
        <div class="row" v-if="items">
            <div class="col-12 col-md-6 col-lg-4 col-xl-3 my-2" v-for="(item, index) in items.data">
                        ...
                        <md-card-media-cover style="height: 300px" >
                            <md-card-media>
                                ...
                                <transition-group name="fade">
                                    <img @click="$emit('selectModel', item)" style="height: 300px; object-fit:cover; cursor: pointer" :key="item.id" :src="getSrc(item.image_pattern)" alt="Skyscraper" v-if="item.isHover">
                                </transition-group>
